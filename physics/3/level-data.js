...
export const LEVEL_QUESTIONS = [
   ...
   //液体压强心法1个
    { id: 'liquid_p', text: '运用液压心法求液体压强', answer: ['p', '=', 'ρ液', '×', 'g', '×', 'h'], hint: '液体压强 等于 液体密度 乘以 g 乘以 深度', display: 'p = \\rho_{\\text{液}}  g  h' },
    //浮力心法6个，4个公式加2个变形
    { id: 'buoyancy_arch1_V', text: '浮力心法之压力差法', answer: ['F浮', '=', 'F向上', '－', 'F向上'], hint: '浮力 等于 物体受到向上的压力 减去 向下的压力', display: 'F_{\\text{浮}} = F_{\\text{向上}} －F_{\\text{向下}}' },
    { id: 'buoyancy_arch2_V', text: '浮力心法之称重法', answer: ['F浮', '=', 'G', '－', 'F拉'], hint: '浮力 等于 物体的重力 减去 拉力', display: 'F_{\\text{浮}} = G －F_{\\text{拉}}' },
    { id: 'buoyancy_arch3_V', text: '浮力心法之阿基米德原理', answer: ['F浮', '=', 'ρ液', '×', 'g', '×', 'V排'], hint: '浮力 等于 液体密度 乘以 g 乘以 排开液体的体积', display: 'F_{\\text{浮}} = ρ_{\\text{液}}   g   V_{\\text{排}}' },
    { id: 'buoyancy_arch4_V', text: '浮力心法之平衡法', answer: ['F浮', '=', 'G物'], hint: '浮力 等于 物体的重力', display: 'F_{\\text{浮}} = G_{\\text{物}}' },
    { id: 'buoyancy_arch_V', text: '运用浮力心法求排开液体的体积', answer: ['V排', '=', 'F浮', '÷', 'g', '÷', 'ρ液'], hint: '排开体积 等于 浮力 除以 (g × 密度)', display: 'V_{\\text{排}} = \\dfrac{F_{\\text{浮}}}{g  \\rho_{\\text{液}}}' },
    { id: 'buoyancy_arch_ρ', text: '运用浮力心法求液体的密度',   answer: ['ρ液', '=', 'F浮', '÷', 'g', '÷', 'V排'], hint: '液体密度 等于 浮力 除以 (g × 排开体积)', display: '\\rho_{\\text{液}} = \\dfrac{F_{\\text{浮}}}{g  V_{\\text{排}}}' },
   //功心法3个
    ...
    //杠杆平衡条件心法1个
    { id: 'lever_F1', text: '杠杆平衡条件', answer: ['F1', '×', 'l1', '=', 'F2', '×', 'l2'], hint: '动力×动力臂 = 阻力×阻力臂', display: 'F_1  l_1 = F_2  l_2' },
    //机械效率心法1个
    { id: 'efficiency', text: '求机械效率', answer: ['η', '=', 'W有', '÷', 'W总'], hint: '机械效率 等于 有用功 除以 总功', display: 'η = \\dfrac{W_{\\text{有}}}{W_{\\text{总}}}' },
   //比热容心法4个
    ...
    { id: 'heatval_V1', text: '当热值单位为J/m³时，运用热值心法求燃料完全燃烧释放的热量', answer: ['Q', '=', 'V', '×', 'q'], hint: '热量 等于 体积 乘以 热值', display: 'Q = V  q' },
     //热效率心法2个
    { id: 'thermaleff_water', text: '热效率心法之烧水类', answer: ['η', '=', 'Q吸', '÷', 'Q放'], hint: '热效率 等于 吸收热量 除以 放出的热量', display: 'η = \\dfrac{Q_{\\text{吸}}}{Q_{\\text{放}}}' },
    { id: 'thermaleff_car', text: '热效率心法之汽车行驶类', answer: ['η', '=', 'W有', '÷', 'Q放'], hint: '热效率 等于 有用功 除以 放出的热量', display: 'η = \\dfrac{W_{\\text{有}}}{Q_{\\text{放}}}' },
    //欧姆心法3个
    ...
    { id: 'elecpower_def_P3', text: '电功率心法之串联型导出式', answer: ['P', '=', 'I²', '×', 'R'], hint: '功率等于电流的平方 乘以 电阻', display: 'P = I^2  R' },
    { id: 'elecpower_def_P4', text: '电功率心法之并联型导出式', answer: ['P', '=', 'U²', '÷', 'R'], hint: '功率等于电压的平方 除以 电阻', display: 'P = \\dfrac{U^2}{R}' },
    { id: 'elecpower_parallel_R', text: '运用电功率并联导出式求电阻', answer: ['R', '=', 'U²', '÷', 'P'], hint: '电阻等于电压的平方 除以 功率', display: 'R = \\dfrac{U^2}{P}' },
    //电热心法1个
    { id: 'elecheat_Q', text: '运用电热心法求电热', answer: ['Q', '=', 'I²', '×', 'R', '×', 't'], hint: '电热等于电流平方 乘以 电阻 乘以 时间', display: 'Q = I^2  R  t' }
];